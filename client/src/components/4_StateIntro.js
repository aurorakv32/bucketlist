//TODO Diagram of the StateIntro code that explains what things are doing.
//Diagram should talk about this.setState and passing in new object that we 
//want to set the state to.
